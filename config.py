...
API_ID = 20009450
API_HASH = "9a601446b607e2fc1baa5b8608b72098"
...
SUDO_USERS = list(map(lambda x: int(x), getenv("SUDO_USERS", default="5242142514").split()))
for x in ALTRON:
    SUDO_USERS.append(x)
OWNER_ID = int(getenv("OWNER_ID", default="5242142514"))
